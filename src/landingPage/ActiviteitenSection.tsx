...
export default function ActiviteitenSection() {
    ...
    return (
        <SectionWrapper
            className="relative bg-white w-full max-w-screen-2xl mx-auto sm:px-8 lg:px-8 xl:px-14 py-14 sm:py-16 flex flex-col gap-12 lg:flex-row items-start lg:items-center overscroll-x-none lg:mt-12">
