...
export default function CabanaSection() {
    ...
    return (
        <SectionWrapper
            className="relative w-full max-w-screen-2xl mx-auto sm:px-8 lg:px-8 xl:px-14 flex flex-col lg:flex-row items-start lg:items-center overscroll-x-none mt-2 sm:mt-4 lg:mt-20">

            <motion.div variants={container}
                className="flex flex-col items-start justify-center w-full lg:w-1/3 mx-auto px-6 sm:px-0 py-12 md:py-12 lg:py-20">
