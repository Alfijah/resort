...
export default function CabanaSection() {
    ...
    return (
        <SectionWrapper
            className="relative w-full max-w-screen-2xl mx-auto sm:px-8 lg:px-20 flex flex-col lg:flex-row items-start lg:items-center overscroll-x-none mt-2 sm:mt-4 lg:mt-20">
