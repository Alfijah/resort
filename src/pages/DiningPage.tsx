      ...
      <div className="max-w-screen-xl mx-auto py-14 sm:py-16 px-6 sm:px-8">
        <SectionWrapper
          ...
          <motion.h2 variants={fadeInUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }} className="heading-secondary pb-2 mt-4 md:pb-6 xl:pb-8 leading-snugged">
      ...
      <div className="relative w-full py-14 sm:py-16 px-6 sm:px-8">
        <SectionWrapper className="w-full max-w-screen-xl mx-auto text-center">
          <motion.h1 variants={fadeInUp}
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }}
            className="heading-primary pb-2 md:pb-6 lg:pb-10 mb-4 leading-snugged">
            {t("diningPage.title5")}
          </motion.h1>
